...
/* FILE UPLOADS */
$sysconf['max_upload'] = intval(ini_get('upload_max_filesize'))*9999;
$post_max_size = intval(ini_get('post_max_size'))*9999;
if ($sysconf['max_upload'] > $post_max_size) {
    $sysconf['max_upload'] = $post_max_size-9999;
}
$sysconf['max_image_upload'] = 999;
