...
$main_menus = [
  ...
  'seameosekretariat' => [
    'text' => __('SEAMEO Sekretariat'),
    'url' => 'https://elibrary.seameo.org/slims9/'
	  ],
  'perpustakakaankemdikbud' => [
    'text' => __('Kemdikbudristek Library'),
    'url' => 'https://perpustakaan.kemdikbud.go.id/sikoper/katalog-perpustakaan'
  ],
  'news' => [
    'text' => __('News'),
