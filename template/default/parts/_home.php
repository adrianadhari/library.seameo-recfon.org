...
<section class="mt-5 container">
    ...
    <ul class="topic d-flex flex-wrap justify-content-center px-0">
        <li class="d-flex justify-content-center align-items-center m-2">
            <a href="index.php?keywords=annual+report&search=search" class="d-flex flex-column">
                <img src="<?php echo assets('images/annual_report.png'); ?>" width="80" class="mb-3 mx-auto"/>
                <?php echo __('Annual Report'); ?>
            </a>
        </li>
        <li class="d-flex justify-content-center align-items-center m-2">
            <a href="index.php?keywords=booklet&search=search" class="d-flex flex-column">
                <img src="<?php echo assets('images/booklet.png'); ?>" width="80" class="mb-3 mx-auto"/>
                <?php echo __('Booklet'); ?>
            </a>
        </li>
        <li class="d-flex justify-content-center align-items-center m-2">
            <a href="index.php?keywords=eccne&search=search" class="d-flex flex-column">
                <img src="<?php echo assets('images/eccne.png'); ?>" width="80" class="mb-3 mx-auto"/>
                <?php echo __('ECCNE'); ?>
            </a>
        </li>
        <li class="d-flex justify-content-center align-items-center m-2">
            <a href="index.php?keywords=iprcertificate&search=search" class="d-flex flex-column">
                <img src="<?php echo assets('images/ipr_certificate.png'); ?>" width="80" class="mb-3 mx-auto"/>
                <?php echo __('IPR Certificate'); ?>
            </a>
        </li>
        <li class="d-flex justify-content-center align-items-center m-2">
...
<section class="mt-5 container">
    <h4 class="text-center text-light py-3 bg-red-dark mb-4">
        <?php echo __('Popular among our collections'); ?>
        <br>
        <small class="subtitle-section"><?php echo __('Our library\'s line of collection that have been favoured by our users were shown here. Look for them. Borrow them. Hope you also like them
');?></small>
    </h4>
...
<section class="mt-5 container">
    <h4 class="text-center text-light py-3 bg-grey-dark mb-4">
...
<section class="mt-5 bg-white">
    <div class="text-center text-grey-dark py-3 bg-grey-dark mb-4">
        <h4 class="text-center text-light py-3 bg-grey-dark mb-4">
